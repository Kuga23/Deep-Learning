...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.output_size=output_size
        self.input_size=input_size
        #self.U = np.random.uniform(0, 1, (self.hidden_size, input_size))
        #self.V = np.random.uniform(0, 1, (hidden_dim, hidden_dim))
        #self.W = np.random.uniform(0, 1, (output_dim, hidden_dim))
        self.hiddenL= nn.Linear(self.input_size+self.hidden_size,self.hidden_size)
        self.outputL= nn.Linear(self.input_size+self.hidden_size,self.output_size)
