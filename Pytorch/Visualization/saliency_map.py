...
attr_sm= compute_attributions(saliency,X_tensor,target=y_tensor)
visualize_attr_maps('visualization/captum_saliency_map.png',X,y,class_names,[attr_sm],['Saliency_map'])
